...
- **모델과 프로젝트** — 현재 모델과 작업 폴더를 대화창을 훑지 않고 확인합니다.
- **컨텍스트 미터** — 현재 context window 기준 토큰 사용량을 짧은 바와 퍼센트로 표시합니다.
- **Git 상태** — 브랜치, 변경 파일 수, upstream 동기화 상태를 보여줍니다.
...
**종합:** 이 repo는 한 줄의 밀도 높은 statusline과 한 줄의 의도 리마인더만 남깁니다. 시각 처리는 장식이 아니라 정보의 우선순위입니다.
